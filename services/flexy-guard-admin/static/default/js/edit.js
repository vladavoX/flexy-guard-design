function init() {
    ...
    $('.js-item-save').on('click', function (e) {
        ...
        if (
            valuesIsNotEmpty(form.find('#card_approved-min').val(), form.find('#card-approved-max').val())
        ) {
            body.card = {};
        ...
        // TODO: compare min and max
        if (
            valuesIsNotEmpty(form.find('#card-count-min').val(), form.find('#card-count-max').val())
        ) {
        ...
        if (
            valuesIsNotEmpty(form.find('#card-amount-daily-min').val(), form.find('#card-amount-daily-max').val())
        ) {
            if (body.card === undefined) {
                body.card = {};
            }
        ...
        if (
            valuesIsNotEmpty(form.find('#card-amount-weekly-min').val(), form.find('#card-amount-weekly-max').val())
        ) {
            if (body.card === undefined) {
                body.card = {};
            }
        ...
        if (
            valuesIsNotEmpty(form.find('#card-amount-monthly-min').val(), form.find('#card-amount-monthly-max').val())
        ) {
            if (body.card === undefined) {
                body.card = {};
            }
        ...
        if (
            valuesIsNotEmpty(form.find('#card-amount-yearly-min').val(), form.find('#card-amount-yearly-max').val())
        ) {
            if (body.card === undefined) {
                body.card = {};
            }
        ...
        if (
            valuesIsNotEmpty(form.find('#card-amount-min').val(), form.find('#card-amount-max').val())
        ) {
            if (body.card === undefined) {
                body.card = {};
            }
        ...
        if (
            valuesIsNotEmpty(form.find('#trx-amount-min').val(), form.find('#trx-amount-max').val())
        ) {
            body.amount = {};
            body.amount.value = {};
        ...
        if (form.find('#bin-not-in-country').val() !== undefined) {
            ...
            body.bin.not_in_country = form.find('#bin-not-in-country').val().split('\n');
        }
        ...
        if (form.find('#ip-not-in-country').val() !== undefined) {
            ...
            body.ip.not_in_ip_country = form.find('#ip-not-in-country').val().split('\n');
        }
